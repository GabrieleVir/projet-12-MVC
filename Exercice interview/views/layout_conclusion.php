		...
		<!-- Wrapper -->
			<div id="wrapper" class="fade-in">
				...
				<!-- Nav -->
					<nav id="nav">
						<ul class="links">
							<li class="layout.php"><a href="index.html">Comment je l'ai trouvé</a></li>
							...
							<li><a href="active">Conclusion</a></li>
						</ul>
						<ul class="icons">
					...
					<div id="main">
						...
						<!-- Featured Post -->
							<article class="post featured">
								...
								<a href="#" class="image main"><img src="assets/img/pic01.jpg" alt="" /></a>
								<ul class="actions">
